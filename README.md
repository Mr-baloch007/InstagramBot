...
This project is an Instagram automation bot developed using Python, combining the `instagrapi` library for interacting with Instagram's private API and `customtkinter` for creating a user-friendly graphical interface. The bot allows users to perform common Instagram tasks—such as following, unfollowing, liking posts, and commenting—directly from a desktop application. With a secure login system and simple design, the tool provides a convenient way to manage Instagram activities efficiently, especially useful for social media managers or users aiming to grow their engagement. The bot automates repetitive tasks while maintaining control through a visual interface. 
